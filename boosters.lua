            ...
            SMODS.Booster {
                ...
                SMODS.Booster {
                    ...
                    create_card = function(self, card, i)
                        ...
                        local random_value = pseudorandom('badshit_mega_arcana_pack_2_card') * total_weight
                        ...
                        if selected_index == 1 then
                            return {
                                ...
                                skip_materialize = true,
                                soulable = true,
                                key_append = "badshit_mega_arcana_pack_2"
                            }
                ...
                SMODS.Booster {
                    ...
                    create_card = function(self, card, i)
                        ...
                        local random_value = pseudorandom('badshit_mega_celestial_pack_2_card') * total_weight
                        local cumulative_weight = 0
                        local selected_index = 1
                        for j, weight in ipairs(weights) do
                            cumulative_weight = cumulative_weight + weight
                        ...
                        if selected_index == 1 then
                            return {
                                ...
                                skip_materialize = true,
                                soulable = true,
                                key_append = "badshit_mega_celestial_pack_2"
                            }
                        elseif selected_index == 2 then
                            return {
                                key = "c_black_hole",
                ...
                SMODS.Booster {
                    ...
                    create_card = function(self, card, i)
                        ...
                        local random_value = pseudorandom('badshit_mega_spectral_pack_card') * total_weight
                        local cumulative_weight = 0
                        local selected_index = 1
                        for j, weight in ipairs(weights) do
                            cumulative_weight = cumulative_weight + weight
                        ...
                        if selected_index == 1 then
                            return {
                                ...
                                skip_materialize = true,
                                soulable = true,
                                key_append = "badshit_mega_spectral_pack"
                            }
                        elseif selected_index == 2 then
                            return {
                                key = "c_soul",
                ...
                SMODS.Booster {
                    ...
                    create_card = function(self, card, i)
                        ...
                        local random_value = pseudorandom('badshit_mega_buffoon_pack_card') * total_weight
                        local cumulative_weight = 0
                        local selected_index = 1
                        for j, weight in ipairs(weights) do
                            cumulative_weight = cumulative_weight + weight
                        ...
                        if selected_index == 1 then
                            return {
                                ...
                                skip_materialize = true,
                                soulable = true,
                                key_append = "badshit_mega_buffoon_pack"
                            }
                        elseif selected_index == 2 then
                            return {
                                set = "Joker",
                    ...
                    SMODS.Booster {
                        key = 'mega_standard_pack_2',
                        loc_txt = {
                            name = "MEGA Mega Standard Pack",
                            text = {
                                [1] = 'Choose {C:attention}4{} of up to {C:attention}10 Playing{} cards to add to your deck'
                            },
                            group_name = "MEGA Mega Standard Pack"
                        },
                    ...
                    SMODS.Booster {
                        key = 'epic_booster_pack_plus',
                        loc_txt = {
                            name = "Epic Booster Pack PLUS",
                            text = {
                                [1] = 'Choose 1 of 3 {C:planet}omega consumables{}'
                            },
                            group_name = "badshit_boosters"
                        },
                        config = { extra = 3, choose = 1 },
                        ...
                        create_card = function(self, card, i)
                            return {
                                ...
                                skip_materialize = true,
                                soulable = true,
                                key_append = "badshit_epic_booster_pack_plus"
                            }
                        end,
                        particles = function(self)
                            G.booster_pack_sparkles = Particles(1, 1, 0, 0, {
                    ...
                    SMODS.Booster {
                        key = 'epic_booster_pack_plus_plus',
                        loc_txt = {
                            name = "Epic Booster Pack PLUS PLUS",
                            text = {
                                [1] = 'Choose 1 of 4 {C:planet}omega consumables{}'
                            },
                            group_name = "badshit_boosters"
                        },
                        config = { extra = 4, choose = 1 },
                        ...
                        create_card = function(self, card, i)
                            return {
                                ...
                                skip_materialize = true,
                                soulable = true,
                                key_append = "badshit_epic_booster_pack_plus_plus"
                            }
                        end,
                        particles = function(self)
                            G.booster_pack_sparkles = Particles(1, 1, 0, 0, {
                    ...
                    SMODS.Booster {
                        key = 'epic_booster_pack',
                        loc_txt = {
                            name = "Epic Booster Pack",
                            text = {
                                [1] = 'Choose 1 of 2 {C:planet}omega consumables{}'
                            },
                            group_name = "badshit_boosters"
                        },
                        config = { extra = 2, choose = 1 },
                        ...
                        create_card = function(self, card, i)
                            return {
                                ...
                                skip_materialize = true,
                                soulable = true,
                                key_append = "badshit_epic_booster_pack"
                            }
                        end,
                        particles = function(self)
                            G.booster_pack_sparkles = Particles(1, 1, 0, 0, {
